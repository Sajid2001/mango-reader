  ...
  return (
    <div className="h-screen bg-background px-5 w-full align-baseline overflow-y-auto">
      <div className="w-full flex flex-col">
        <div className=" flex flex-wrap *:pt-3 pb-4">
          ...
          <div className="flex m-1 *:mr-2">
            <button
              ...
              className="py-1  mb-3 font-semibold text-lg px-5 text-background bg-accent rounded-lg active:bg-slate-700"
            >
              Clear History
            </button>
        ...
        historicalData.some(
          (entry) => entry.lastViewed !== null || entry.lastViewed !== undefined
        ) ? (
          <div>
            {historicalData.map((entry, index) => {
              ...
              if (
                prevDate === undefined ||
                new Date(entry.lastViewed!).toLocaleDateString() !==
                ...
                header = (
                  <div>
                    <p className="text-2xl p-2 my-6 border-b-4 border-secondary font-semibold">
                      ...
                      {new Date(entry.lastViewed!).getFullYear()}
                    </p>
                  </div>
                );
              }
                ...
                <div className="flex my-4 justify-between" key={index}>
                  <div className="flex items-center">
                    <img
                      ...
                      className=" aspect-[2/3] rounded-2xl object-fit w-40"
                      alt=""
                    />
                    <div className="flex flex-col">
                      <p className="text-2xl px-4 border-secondary font-bold">
                        {entry.manga.title}
                      </p>
                      <p className="text-2xl px-4 border-secondary">
